...
delete from web_returns where wr_order_number in (select distinct ws_order_number from web_sales, date_dim where ws_sold_date_sk=d_date_sk and d_date between 'DATE1' and 'DATE2');
