...
delete from catalog_returns where cr_order_number in  (select distinct cs_order_number from catalog_sales, date_dim  where cs_sold_date_sk=d_date_sk and d_date between 'DATE1' and 'DATE2');
